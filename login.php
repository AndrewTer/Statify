  ...
  <body>
    ...
    <div class="container-fluid main-body p-0">
      <div class="login-content text-white">
        <div class="row d-flex flex-row align-items-center" style="min-height: 88vh;">

          <div class="w-100 m-0 p-0 d-flex flex-row align-items-center">
            <div class="col-12 col-sm-7 col-md-8 col-lg-8 col-xl-8 content-section h-100 justify-content-center align-self-start">
              <p class="fz-20 m-0 mt-2"><span id="service-name" class="fz-25 text-white">Statify</span> - сервис для оценивания фотографий людей</p>
              <hr class="hr-user-info mt-3 mb-3">
              <section class="m-0 p-3 description-section">
                <div class="m-0 p-0 d-flex flex-row align-items-center">
                  ...
                  <p class="m-0 ml-4 p-0 fz-16">Делитесь своими фотографиями</p>
                </div>
                ...
                <div class="m-0 mt-3 p-0 d-flex flex-row align-items-center">
                  ...
                  <p class="m-0 ml-4 p-0 fz-16">Оценивайте фотографии других пользователей</p>
                </div>
                ...
                <div class="m-0 mt-3 p-0 d-flex flex-row align-items-center">
                  ...
                  <p class="m-0 ml-4 p-0 fz-16">Сохраняйте понравившиеся фотографии</p>
                </div>
                ...
                <div class="m-0 mt-3 p-0 d-flex flex-row align-items-center">
                  ...
                  <p class="m-0 ml-4 p-0 fz-16">Формируйте свой рейтинг</p>
                </div>
                ...
                <div class="m-0 mt-3 p-0 d-flex flex-row align-items-center">
                  ...
                  <p class="m-0 ml-4 p-0 fz-16">Комментируйте</p>
                </div>
                ...
                <div class="m-0 mt-3 p-0 d-flex flex-row align-items-center">
                  ...
                  <p class="m-0 ml-4 p-0 fz-16">Добавляйте новых друзей</p>
                </div>
              </section>
            </div>
