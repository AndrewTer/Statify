...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Страница со списком фотографий пользователя на сайте Statify">
  ...
  <body>
    ...
    <div class="container-fluid main-body p-0">
      <div class="row main-block m-0">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 main-content-photo">
          <div class="content container-fluid row m-0 p-0 block-photo"><? include("includes/photo/photo-content.php"); ?></div>
        </div>
      </div>
    </div>
