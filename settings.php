...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Настройки страницы пользователя сайта">
  ...
  <body>
    ...
    <div class="container-fluid main-body p-0">
      <div class="row main-block m-0">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 main-content-settings">
          <div class="content container-fluid edit-container row m-0"><? include("includes/settings-content.php"); ?></div>
        </div>
      </div>
    </div>
