...
function showMorePopularPhotosSortedByRating(current_user)
{
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      $('#show-more-popular-photos-sorted-by-rating').html('<h5 class="fz-15 m-0 p-0 font-weight-bold">По рейтингу</h5><p class="m-0 ml-auto mr-0 p-0 fz-14 news-popular-top-p" onclick="event.preventDefault();hideMorePopularPhotosSortedByRating(\'' + current_user +'\');">Скрыть</p>');
    }
  });
}
...
function hideMorePopularPhotosSortedByRating(current_user) 
{
  ...
  $('#show-more-popular-photos-sorted-by-rating').html('<h5 class="fz-15 m-0 p-0 font-weight-bold">По рейтингу</h5><p class="m-0 ml-auto mr-0 p-0 fz-14 news-popular-top-p" onclick="event.preventDefault();showMorePopularPhotosSortedByRating(\'' + current_user + '\');">Топ 100</p>');
}
...
function showMorePopularPhotosSortedByNumberOfSaves(current_user)
{
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      $('#show-more-popular-photos-sorted-by-number-of-saves').html('<h5 class="fz-15 m-0 p-0 font-weight-bold">Самые сохраняемые</h5><p class="m-0 ml-auto mr-0 p-0 fz-14 news-popular-top-p" onclick="event.preventDefault();hideMorePopularPhotosSortedByNumberOfSaves(\'' + current_user +'\');">Скрыть</p>');
    }
  });
}
...
function hideMorePopularPhotosSortedByNumberOfSaves(current_user) 
{
  ...
  $('#show-more-popular-photos-sorted-by-number-of-saves').html('<h5 class="fz-15 m-0 p-0 font-weight-bold">Самые сохраняемые</h5><p class="m-0 ml-auto mr-0 p-0 fz-14 news-popular-top-p" onclick="event.preventDefault();showMorePopularPhotosSortedByNumberOfSaves(\'' + current_user + '\');">Топ 100</p>');
}
...
function showMorePopularPhotosSortedByNumberOfComments(current_user)
{
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      $('#show-more-popular-photos-sorted-by-number-of-comments').html('<h5 class="fz-15 m-0 p-0 font-weight-bold">Самые комментируемые</h5><p class="m-0 ml-auto mr-0 p-0 fz-14 news-popular-top-p" onclick="event.preventDefault();hideMorePopularPhotosSortedByNumberOfComments(\'' + current_user +'\');">Скрыть</p>');
    }
  });
}
...
function hideMorePopularPhotosSortedByNumberOfComments(current_user) 
{
  ...
  $('#show-more-popular-photos-sorted-by-number-of-comments').html('<h5 class="fz-15 m-0 p-0 font-weight-bold">Самые комментируемые</h5><p class="m-0 ml-auto mr-0 p-0 fz-14 news-popular-top-p" onclick="event.preventDefault();showMorePopularPhotosSortedByNumberOfComments(\'' + current_user + '\');">Топ 100</p>');
}
