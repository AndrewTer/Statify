<div class="m-0 p-0" id="preferences-content">
...
<?
    ...
    {
?>  
    <form id="edit-user-preferences-block" data-attr="<?= $user_uuid; ?>" action="" method="POST" onSubmit="return editUserPreferencesValidation();">
