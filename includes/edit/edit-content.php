...
<div class="col-12 col-sm-7 col-md-7 col-lg-7 edit-user-info">
  ...
  <div class="block-edit-user-preferences p-0"><? include('includes/edit/edit-user-preferences.php'); ?></div>
  <div class="block-edit-user-interests p-0"><? include('includes/edit/edit-user-interests.php'); ?></div>
</div>
