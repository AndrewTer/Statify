...
?>  
    <form id="edit-user-interests-block" data-attr="<?= $user_uuid; ?>" action="" method="POST" onSubmit="return editUserInterestsValidation();">
      <div class="form-group col-12" id="edit-gender-preference">
        <div class="row m-0">
          <label class="font-weight-bold col-6 p-0 m-0 d-flex align-items-center">Пол</label>
          <select class="form-control col-6 input-field" id="edit-input-select-gender-preference">
          <?
      ...
      <div class="form-group col-12" id="edit-age-preference">
        <div class="row m-0">
          <label class="font-weight-bold col-6 p-0 m-0 d-flex align-items-center">Возрастной диапазон</label>
