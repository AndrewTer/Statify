<div class="block-search-and-sort mt-3 p-0 text-center d-none d-md-block" id="comments-block-user-rating">
  <div class="m-0 p-0" id="comments-rating-area">
    <p class="fz-14 fw-700 m-0 p-2">Статистика</p>
    ...
    <div class="row m-0 p-0 mt-2 mb-2 ml-3 mr-3 d-flex align-items-center justify-content-center">
        ...
        <div class="w-100 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
            ...
            <i class="fa fa-star-o active-star fz-13 p-1" aria-hidden="true"></i>
            <i class="fa fa-star-o active-star fz-13 p-1" aria-hidden="true"></i>
            <p class="fz-13 p-1 ml-auto m-0"><?= rounding_number_by_places(get_user_photo_statistics_stars_count($user_uuid, $photo_uuid, 5)); ?></p>
        </div>
        ...
        <div class="w-100 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
            ...
            <p class="fz-13 p-1 ml-auto m-0"><?= rounding_number_by_places(get_user_photo_statistics_stars_count($user_uuid, $photo_uuid, 4)); ?></p>
        </div>
        ...
        <div class="w-100 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
            ...
            <i class="fa fa-star-o unactive-star fz-13 p-1" aria-hidden="true"></i>
            <i class="fa fa-star-o unactive-star fz-13 p-1" aria-hidden="true"></i>
            <p class="fz-13 p-1 ml-auto m-0"><?= rounding_number_by_places(get_user_photo_statistics_stars_count($user_uuid, $photo_uuid, 3)); ?></p>
        </div>
        ...
        <div class="w-100 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
            ...
            <i class="fa fa-star-o unactive-star fz-13 p-1" aria-hidden="true"></i>
            <i class="fa fa-star-o unactive-star fz-13 p-1" aria-hidden="true"></i>
            <p class="fz-13 p-1 ml-auto m-0"><?= rounding_number_by_places(get_user_photo_statistics_stars_count($user_uuid, $photo_uuid, 2)); ?></p>
        </div>
        ...
        <div class="w-100 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
            ...
            <i class="fa fa-star-o unactive-star fz-13 p-1" aria-hidden="true"></i>
            <i class="fa fa-star-o unactive-star fz-13 p-1" aria-hidden="true"></i>
            <p class="fz-13 p-1 ml-auto m-0"><?= rounding_number_by_places(get_user_photo_statistics_stars_count($user_uuid, $photo_uuid, 1)); ?></p>
        </div>
...
?>
      ...
      <div class="d-flex flex-row justify-content-center align-items-center p-1">
        <div class="m-0 mr-auto ml-5 p-0 d-flex flex-column justify-content-center align-items-center">
          ...
          <p class="fz-12 p-1 pt-2 pb-0 m-0"><?= rounding_number_by_places(get_user_photo_statistics_saves_count($user_uuid, $photo_uuid, 'all')); ?></p>
        </div>
        ...
        <div class="m-0 p-0 d-flex flex-column justify-content-center align-items-center">
          ...
          <p class="fz-12 p-1 pt-2 pb-0 m-0"><?= rounding_number_by_places(get_user_photo_statistics_saves_count($user_uuid, $photo_uuid, 'male')); ?></p>
        </div>
        ...
        <div class="m-0 mr-5 ml-auto p-0 d-flex flex-column justify-content-center align-items-center">
          ...
          <p class="fz-12 p-1 pt-2 pb-0 m-0"><?= rounding_number_by_places(get_user_photo_statistics_saves_count($user_uuid, $photo_uuid, 'female')); ?></p>
        </div>
      </div>
<?
    }
