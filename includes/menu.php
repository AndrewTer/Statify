<div class="main-menu m-0 p-0">
  <a class="w-100 m-0 p-0 pl-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="./" aria-label="Профиль">
    ...
    <p class="fz-13 w-100 m-0 ml-3 p-0 pt-1 pb-1 text-left">Профиль</p>
  </a>
  ...
  <a class="w-100 m-0 p-0 pl-2 pt-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="news?sort=popular" aria-label="Новости">
    ...
    <p class="fz-13 w-100 m-0 ml-3 p-0 text-left">Новости</p>
  </a>
  ...
  <a class="w-100 m-0 p-0 pl-2 pt-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="friends?sort=all-friends" aria-label="Друзья">
    ...
    <p class="fz-13 w-100 m-0 ml-3 p-0 pt-1 pb-1 text-left">Друзья</p>
  </a>

  <a class="w-100 m-0 p-0 pl-2 pt-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="search" aria-label="Поиск">
    <svg class="m-0 p-0 svg-search-main-menu-icon" width="25px" height="25px" viewBox="0 0 24 24" fill="none">
    ...
    <p class="fz-13 w-100 m-0 ml-3 p-0 text-left">Поиск</p>
  </a>

  <div class="w-100 m-0 p-0 pt-2 pb-2 d-flex flex-row font-weight-bold">
    <p class="fz-13 w-25 m-0 p-0 icon-main-menu"></p>
    <hr class="w-60 ml-2 p-0 hr-user-info">
  </div>

  <a class="w-100 m-0 p-0 pl-2 pt-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="rate" aria-label="Оценить">
    <svg class="m-0 p-0 svg-rate-main-menu-icon" width="25px" height="25px" viewBox="0 0 24 24" fill="none">
    ...
    <p class="fz-13 w-100 m-0 ml-3 p-0 text-left">Оценить</p>
  </a>
</div>
