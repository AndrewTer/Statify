<div class="main-menu m-0 p-0">
  <a class="w-100 m-0 p-0 pl-2 pb-2 d-flex flex-row align-items-center" data-href="./" aria-label="Профиль">
  ...
  <a class="w-100 m-0 p-0 pl-2 pt-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="friends" aria-label="Друзья">
    ...
    <p class="fz-15 w-100 m-0 ml-3 p-0 text-left font-weight-bold">Друзья</p>
  </a>
  ...
  <a class="w-100 m-0 p-0 pl-2 pt-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="search" aria-label="Поиск">
    ...
    <p class="fz-15 w-100 m-0 ml-3 p-0 text-left font-weight-bold">Поиск</p>
  </a>

  <div class="w-100 m-0 p-0 pt-2 pb-2 d-flex flex-row font-weight-bold">
    <p class="fz-15 w-25 m-0 p-0 icon-main-menu"></p>
  ...
  <a class="w-100 m-0 p-0 pl-2 pt-2 pb-2 d-flex flex-row align-items-center font-weight-bold" data-href="rate" aria-label="Оценить">
    ...
    <p class="fz-15 w-100 m-0 ml-3 p-0 text-left font-weight-bold">Оценить</p>
  </a>
</div>
