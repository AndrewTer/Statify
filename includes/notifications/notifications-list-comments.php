<? include("requests/all-comments-notifications-list.php"); ?>
...
<?
	...
	if ($page != 1) 
		$pervpage = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center font-weight-bold" href="notifications.php?sort=comments&page=1">'
                    ...
                    <svg width="20px" height="20px" viewBox="0 0 48 48" fill="var(--main-text-color)">
                      ...
                      <path d="M27.8,24,38.4,34.6a1.9,1.9,0,0,1-.2,3,2.1,2.1,0,0,1-2.7-.2l-11.9-12a1.9,1.9,0,0,1,0-2.8l11.9-12a2.1,2.1,0,0,1,2.7-.2,1.9,1.9,0,0,1,.2,3Z"></path>
								...
								.'</a>'
								.'<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center" href="notifications?sort=comments&page='.($page - 1).'">'
								.'<p class="m-0 p-0">
                    <svg width="20px" height="20px" viewBox="0 0 48 48" fill="var(--main-text-color)">
	...
	if ($page != $total_count_notifications_pages) 
		$nextpage = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center font-weight-bold" href="notifications?sort=comments&page='.($page + 1).'">'
								.'<p class="m-0 p-0">
                    <svg width="20px" height="20px" viewBox="0 0 48 48" fill="var(--main-text-color)">
                      <path d="M27.2,24,16.6,34.6a1.9,1.9,0,0,0,.2,3,2.1,2.1,0,0,0,2.7-.2l11.9-12a1.9,1.9,0,0,0,0-2.8l-11.9-12a2.1,2.1,0,0,0-2.7-.2,1.9,1.9,0,0,0-.2,3Z"></path>
								...
								.'</a>'
								.'<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center" href="notifications?sort=comments&page='.$total_count_notifications_pages.'">'
								.'<p class="m-0 p-0">
                    <svg width="20px" height="20px" viewBox="0 0 48 48" fill="var(--main-text-color)">
	...
	if ($page - 2 > 0) $page2left = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center font-weight-bold" href="notifications?sort=comments&page='.($page - 2).'">'.($page - 2).'</a>';
	if ($page - 1 > 0) $page1left = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center font-weight-bold" href="notifications?sort=comments&page='.($page - 1).'">'.($page - 1).'</a>';
	if ($page + 2 <= $total_count_notifications_pages) $page2right = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center font-weight-bold" href="notifications?sort=comments&page='.($page + 2).'">'.($page + 2).'</a>';
	if ($page + 1 <= $total_count_notifications_pages) $page1right = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center font-weight-bold" href="notifications?sort=comments&page='.($page + 1).'">'.($page + 1).'</a>';
