...
<div class="cookie-container w-100 m-0 p-0 d-flex flex-row justify-content-center">
    <div class="m-0 p-0 w-100 d-flex flex-row align-items-center justify-content-center">
        ...
        <p class="btn btn-standard m-0 ml-2 mr-2 d-flex justify-content-center align-items-center" id="accept-cookies" onclick="event.preventDefault();acceptCookies();">Принять</p>
    </div>
</div>
<?
    }
