...
<?
            ...
            {
?>
                <p class="username pointer text-hover search-content w-100 fz-16 d-flex align-items-center"><?= get_user_fullname($subscriber_uuid); ?>
...
<?
            ...
            {
?>
                <p class="username pointer text-hover w-100 fz-16 m-0 search-content"><?= get_user_fullname($subscriber_uuid); ?></p>
<?
            }
?>
              </a>
