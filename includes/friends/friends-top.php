...
?>
  <div class="block-user-content mb-3">
    <div class="w-100 m-0 p-0 d-flex flex-row align-items-center">
      <p class="m-0 ml-auto mr-auto p-0 fz-15 d-flex flex-row align-items-center">
        <svg class="mr-2" fill="var(--main-text-color)" width="15px" height="15px" viewBox="0 -32 576 576" xmlns="http://www.w3.org/2000/svg">
...
?>
        ...
        <!--<p class="friends-card-name">Вы</p>-->
      </div>
<?
        }else 
        {
