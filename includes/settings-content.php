  ...
  <div class="block-edit-user-info p-0" id="all-user-settings-block" data-attr="<?= $user_uuid; ?>">
    ...
    <div class="modal-body settings-modal-body">
      <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        <p class="fz-13 font-weight-bold letter-spacing-05 m-0 p-0 justify-content-start w-25">Email</p>
        ...
        <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-25">
          <p class="m-0 p-0 text-right">
            <a class="settings-edit-link letter-spacing-05" data-toggle="collapse" role="button" href="#editEmailBlock" aria-expanded="false" aria-controls="editEmailBlock">Изменить</a>
          ...
          <form class="m-0 p-0 w-100" id="edit-user-email-block" action="" method="POST" onSubmit="return editUserEmailValidation();">       
            <div class="form-group w-100 m-0 p-0">
              <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0">
                <label class="font-weight-bold letter-spacing-05 col-6 p-0 m-0">Новый email</label>
            ...
            <div class="form-group w-100 m-0 p-0">
              <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0">
                <label class="font-weight-bold letter-spacing-05 col-6 p-0 m-0">Текущий пароль</label>
    ...
    <div class="modal-body settings-modal-body">
      <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        <p class="fz-13 font-weight-bold letter-spacing-05 m-0 p-0 justify-content-start w-25">Пароль</p>
        <p class="fz-13 m-0 p-0 justify-content-center w-50"></p>
        <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-25">
          <p class="m-0 p-0 text-right">
            <a class="settings-edit-link letter-spacing-05" data-toggle="collapse" role="button" href="#editPasswordBlock" aria-expanded="false" aria-controls="editPasswordBlock">Изменить</a>
      ...
      <div class="modal-body settings-modal-body pt-0">
        ...
        <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
          ...
          <form class="m-0 p-0 w-100" id="edit-user-password-block" action="" method="POST" onSubmit="return editUserPasswordValidation();">     
            ...
            <div class="form-group w-100 m-0 p-0">
              <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0">
                <label class="font-weight-bold letter-spacing-05 col-6 p-0 m-0">Новый пароль</label>
            ...
            <div class="form-group w-100 m-0 p-0">
              <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0">
                <label class="font-weight-bold letter-spacing-05 col-6 p-0 m-0">Повторите пароль</label>
      ...
      <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        <form class="m-0 p-0 w-100" id="edit-private-settings-block" action="" method="POST" onSubmit="return editUserPrivatePreferences('<?= $user_uuid; ?>');">
          <div class="m-0 p-0 d-flex justify-content-center align-items-center">
            <p class="fz-13 font-weight-bold letter-spacing-05 m-0 p-0 justify-content-start w-50">Кто может оценивать мои фотографии</p>
            <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-50">
              <div class="p-0 m-0 d-flex flex-wrap justify-content-end align-items-center">
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="letter-spacing-05 m-0 text-center" for="who-can-rate-photos-all">Все пользователи</label>
                </div>
                ...
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="letter-spacing-05 m-0 text-center" for="who-can-rate-photos-friends">Только друзья</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="m-0 mt-3 p-0 d-flex justify-content-center align-items-center">
            <p class="fz-13 font-weight-bold letter-spacing-05 m-0 p-0 justify-content-start w-50">Кто может комментировать мои фотографии</p>
            <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-50">
              <div class="p-0 m-0 d-flex flex-wrap justify-content-end align-items-center">
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="letter-spacing-05 m-0 text-center" for="who-can-comment-photos-all">Все пользователи</label>
                </div>
                ...
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="letter-spacing-05 m-0 text-center" for="who-can-comment-photos-friends">Только друзья</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="m-0 mt-3 p-0 d-flex justify-content-center align-items-center">
            <p class="fz-13 font-weight-bold letter-spacing-05 m-0 p-0 justify-content-start w-50">Кто может читать комментарии к моим фотографиям</p>
            <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-50">
              <div class="p-0 m-0 d-flex flex-wrap justify-content-end align-items-center">
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="letter-spacing-05 m-0 text-center" for="who-can-read-comments-on-photos-all">Все пользователи</label>
                </div>
                ...
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="letter-spacing-05 m-0 text-center" for="who-can-read-comments-on-photos-friends">Только друзья</label>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="modal-body settings-modal-body">
      <div class="d-flex flex-wrap justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        ...
        <div class="m-2 ml-5 mr-5 p-0 justify-content-center align-items-center text-center">
          <p class="fz-13 font-weight-bold letter-spacing-05 m-0 mb-2 p-0">Тёмная тема</p>
        ...
        <div class="m-2 ml-5 mr-5 p-0 justify-content-center align-items-center text-center">
          <p class="fz-13 font-weight-bold letter-spacing-05 m-0 mb-2 p-0">Светлая тема</p>
          <div class="m-0 p-0 d-flex flex-row justify-content-center align-items-center">
        ...
        <div class="m-2 ml-5 mr-5 p-0 justify-content-center align-items-center text-center">
          <p class="fz-13 font-weight-bold letter-spacing-05 m-0 mb-2 p-0">Градиент</p>
    ...
    <div class="modal-body settings-modal-body">
      <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        <div class="m-0 p-0 d-flex align-items-center" id="terminate-all-sessions" onclick="event.preventDefault();terminateAllSessions();">
          ...
          <p class="m-0 p-0 fz-14 font-weight-bold letter-spacing-05 text-danger">Завершить все сеансы кроме текущего</p>
        </div>
      </div>
    </div>
