  ...
  <div class="block-edit-user-info p-0" id="all-user-settings-block" data-attr="<?= $user_uuid; ?>">
      ...
      <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        ...
        <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-25">
          <p class="m-0 p-0 text-right">
            <a class="settings-edit-link" data-toggle="collapse" role="button" href="#editEmailBlock" aria-expanded="false" aria-controls="editEmailBlock">Изменить</a>
        ...
        <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
          ...
          <form class="m-0 p-0 w-100" id="edit-user-email-block" action="" method="POST" onSubmit="return editUserEmailValidation();">       
            ...
            <div class="d-flex justify-content-center m-0 p-0">
              <input type="submit" class="btn btn-standard w-50 mt-3" value="Сохранить">
            </div>
          </form>
    ...
    <div class="modal-body settings-modal-body">
      <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        ...
        <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-25">
          <p class="m-0 p-0 text-right">
            <a class="settings-edit-link" data-toggle="collapse" role="button" href="#editPasswordBlock" aria-expanded="false" aria-controls="editPasswordBlock">Изменить</a>
            ...
            <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-50">
              <div class="p-0 m-0 d-flex flex-wrap justify-content-end align-items-center">
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="m-0 text-center" for="who-can-rate-photos-all">Все пользователи</label>
                </div>
                ...
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="m-0 text-center" for="who-can-rate-photos-friends">Только друзья</label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-50">
              <div class="p-0 m-0 d-flex flex-wrap justify-content-end align-items-center">
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="m-0 text-center" for="who-can-comment-photos-all">Все пользователи</label>
                </div>
                ...
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="m-0 text-center" for="who-can-comment-photos-friends">Только друзья</label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="fz-13 font-weight-bold m-0 p-0 justify-content-end w-50">
              <div class="p-0 m-0 d-flex flex-wrap justify-content-end align-items-center">
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="m-0 text-center" for="who-can-read-comments-on-photos-all">Все пользователи</label>
                </div>
                ...
                <div class="radio_btn settings_radio_btn m-1">
                  ...
                  <label class="m-0 text-center" for="who-can-read-comments-on-photos-friends">Только друзья</label>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="modal-body settings-modal-body">
      <div class="d-flex flex-row justify-content-center align-items-center m-0 p-0 pt-1 pb-1 w-100">
        <p class="fz-14 font-weight-bold m-0 p-0 text-danger d-flex align-items-center" id="terminate-all-sessions" onclick="event.preventDefault();terminateAllSessions();">
