<div class="block-search-and-sort mb-3 p-0">
  <table class="table table-borderless m-0">
    <tbody>
        <tr class="news-sort-list-item first-item font-weight-bold" data-href="news?sort=mine">
          <th scope="row">
            Мои новости
          </th>
        </tr>

        <tr class="news-sort-list-item font-weight-bold" data-href="news?sort=friends">
          <th scope="row">
            Новости друзей
          </th>
        </tr>
