...
<?
  ...
  if($page - 2 > 0) $page2left = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center" href="news?sort=friends&page='. ($page - 2) .'" aria-label="Переход на две страницы назад">'. ($page - 2) .'</a>';
  if($page - 1 > 0) $page1left = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center" href="news?sort=friends&page='. ($page - 1) .'" aria-label="Переход на предыдущую страницу с новостями">'. ($page - 1) .'</a>';
  if($page + 2 <= $total_count_news_pages) $page2right = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center" href="news?sort=friends&page='. ($page + 2) .'" aria-label="Переход на две страницы вперёд">'. ($page + 2) .'</a>';
  if($page + 1 <= $total_count_news_pages) $page1right = '<a class="fz-13 m-2 pt-1 pb-1 page-num d-flex justify-content-center align-items-center" href="news?sort=friends&page='. ($page + 1) .'" aria-label="Переход на следующую страницу с новостями">'. ($page + 1) .'</a>';
