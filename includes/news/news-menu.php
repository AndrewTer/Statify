<div class="block-search-and-sort mb-3 p-0">
  <table class="table table-borderless m-0">
    <tbody>
        <tr class="news-sort-list-item first-item font-weight-bold" data-href="news?sort=feed">
          <th scope="row" class="fz-14 pl-3 pr-3">
            Моя лента
          </th>
        </tr>

        <tr class="news-sort-list-item last-item font-weight-bold" data-href="news?sort=popular">
          <th class="d-flex flex-row align-items-center fz-14 pl-3 pr-3">
            Популярное
            <svg class="ml-auto mr-0" width="17px" height="17px" viewBox="0 0 256 256" fill="url(#popular-logo-gradient)">
              <defs>  
                <linearGradient id="popular-logo-gradient" x1="50%" y1="0%" x2="50%" y2="100%" >
