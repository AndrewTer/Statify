...
<?
        ...
        {
?>
          <p class="username pointer text-hover w-100 fz-16 d-flex align-items-center"><?= get_user_fullname($search_uuid); ?>
...
<?
        ...
        {
?>
          <p class="username pointer text-hover w-100 fz-16 m-0"><?= get_user_fullname($search_uuid); ?></p>
<?
        }
?>
          </a>
