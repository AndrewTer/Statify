<div class="w-100 row m-0 p-0 d-flex flex-row justify-content-between">
  <div class="block-user-content block-with-amounts m-0 mb-2 p-2">
    <a class="w-100 m-0 p-0 d-flex flex-row align-items-center" href="photos">
      <div class="amount-value d-flex justify-content-center align-items-center">
        <svg fill="var(--main-menu-icon-color)" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25px" height="25px" viewBox="0 0 31.06 32.001" xml:space="preserve">
      ...
      <div class="m-0 mr-auto p-0 d-flex flex-column amount-value-text-block">
        <p class="m-0 p-0 font-weight-bold amount-value-text-number"><?= get_photos_count($user_uuid); ?></p>
        <p class="m-0 p-0 amount-value-text">Фотографии</p>
      </div>
    </a>
  </div>

  <div class="block-user-content block-with-amounts m-0 mb-2 p-2">
    <a class="w-100 m-0 p-0 d-flex flex-row align-items-center" href="saves">
      <div class="amount-value d-flex justify-content-center align-items-center">
        <svg fill="var(--main-menu-icon-color)" width="25px" height="25px" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="m-0 mr-auto p-0 d-flex flex-column amount-value-text-block">
        <p class="m-0 p-0 font-weight-bold amount-value-text-number"><?= get_saves_count($user_uuid); ?></p>
        <p class="m-0 p-0 amount-value-text">Сохранения</p>
      </div>
    </a>
  </div>

  <div class="block-user-content block-with-amounts m-0 mb-2 p-2" id="number-of-comments-by-current-user" onclick="event.preventDefault();showUserCommentsList(<?= '\''.$user_uuid.'\''; ?>);">
    <a class="w-100 m-0 p-0 d-flex flex-row align-items-center">
      <div class="amount-value d-flex justify-content-center align-items-center">
      ...
      <div class="m-0 mr-auto p-0 d-flex flex-column amount-value-text-block">
        <p class="m-0 p-0 font-weight-bold amount-value-text-number"><?= count(get_current_user_comments_list($user_uuid)); ?></p>
        <p class="m-0 p-0 amount-value-text">Комментарии</p>
      </div>
    </a>
  </div>
</div>