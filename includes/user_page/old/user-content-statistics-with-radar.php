<div class="row m-0 mt-1 p-0">
  ...
  <div id="block-rating-left" class="p-0">
...
?>
  ...
  <div id="block-rating-right" class="p-0">
    <div class="block-user-content h-100 d-flex justify-content-center align-items-center row m-0">
<?
        if ($page_status)
          echo '<div class="chart radar-chart w-100 pt-4 pb-1">
