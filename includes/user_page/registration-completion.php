<?
	...
	{
?>
	<div class="m-0 p-0 w-100 person-info" id="block-with-registration-completion">
		<div class="block-user-content" id="registration-completion">
   	 		<h5 class="text-center fz-18 font-weight-bold">Завершение регистрации</h5>
...
?>
			      ...
			      <div class="m-0 mt-4 p-0 d-flex flex-row justify-content-center">
			      	<input type="submit" class="btn btn-standard user-profile-action-btn p-1" value="Сохранить">
			      </div>
    			</form>
    		</div>
