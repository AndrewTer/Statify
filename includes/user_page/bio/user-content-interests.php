...
<?
  switch ($user_gender_preference) {
    case 'male':
      echo '<svg class="m-0 p-0" width="14px" height="14px" fill="var(--main-text-color)" viewBox="0 0 256 256">
...
<?
  if ($user_minimum_age_preference && $user_maximum_age_preference)
    echo '<svg class="m-0 p-0" width="14px" height="14px" fill="var(--main-text-color)" viewBox="0 0 32 32">
