...
?>
                  <tr class="w-100 d-flex flex-row align-items-center">
                    ...
                    <td class="col-3 text-center font-weight-bold"
...
?>
                ...
                <tr class="w-100 d-flex flex-row align-items-center pl-3 pr-3">
                  ...
                  <td class="col-4"></td>
                  <td class="col-3 text-right font-weight-bold"
...
?>
    ...
    <div class="block-user-content mt-3" id="block-user-content-history">  
      <h5 class="position-relative fz-14 text-center font-weight-bold">История оценок
<?
      if ($premium_status)
      {
?>
...
?>
        <table class="table table-borderless table-user-statistics w-100 m-0">
          <tbody>
            <tr>
              <td class="fz-12 font-weight-bold">Среди пользователей</td>
...
<? 
            switch ($user_gender) {
              case 'male':
                echo '<tr>
                        <td class="fz-12 font-weight-bold">Среди мужской аудитории</td>
              ...
              case 'female':
                echo '<tr>
                        <td class="fz-12 font-weight-bold">Среди женской аудитории</td>
                        <th class="fz-12" scope="row">'.$user_among_gender.'&nbsp;из&nbsp;'.$all_gender_users.'</th>
                      </tr>';
                break;
...
?>
            <tr>
              <td class="fz-12 font-weight-bold">Среди друзей</td>
              <th class="fz-12" scope="row"><?= $user_among_friends.'&nbsp;из&nbsp;'.$all_friends_users; ?></th>
            </tr>
            <tr>
              <td class="fz-12 font-weight-bold">По городу</td>
              <th class="fz-12" scope="row"><?= $user_among_city.'&nbsp;из&nbsp;'.$all_city_users; ?></th>  
            </tr>
            <tr>
              <td class="fz-12 font-weight-bold">По стране</td>
