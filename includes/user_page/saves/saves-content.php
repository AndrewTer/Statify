<script defer type="text/javascript" src="js/saves.js"></script>
<?
...
?>
    ...
    <div class="col-md-2 d-none d-md-block section-search-and-sort mb-3 p-0" id="saves-menu">
<?
      include('saves-menu.php');
?>
    </div>
<?
  }else
