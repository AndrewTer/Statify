...
<?
  ...
  {
?>
  <span class="m-0 mt-1 p-0 d-flex flex-row align-items-stretch">
    <p class="m-0 p-0">
      <svg class="active-star" width="23px" height="23px" viewBox="0 0 24 24" fill="none">
    ...
    <p class="m-0 ml-1 p-0 fz-16 font-weight-bold"><?= (get_user_rating_among_all_users($current_user_uuid) != 0) ? get_user_rating_among_all_users($current_user_uuid) : '0 %'; ?></p>
  </span>
<?
  }
?>
  <span class="m-0 mt-1 p-0 font-weight-bold d-flex flex-row align-items-center">
    <p class="m-0 p-0">
      <svg class="m-0 p-0" width="10px" height="10px" viewBox="-4.5 0 20 20" fill="var(--main-text-color)">
    ...
    <p class="m-0 ml-1 p-0 fz-13 pointer font-weight-bold" id="more-user-info">Подробнее</p>
  </span>
<?
        ...
        echo '<div class="m-0 p-0 mt-2 d-flex flex-row justify-content-center align-items-center">
                ...
                <div class="m-0 p-0" role="group">
                  ...
                  <div class="dropdown-menu dropdown-menu-right user-profile-dropdown-menu mt-1 p-0" aria-labelledby="user-profile-more-menu-icon">
                    <a class="dropdown-item only-one-item pt-2 pb-2 font-weight-bold" 
        ...
        echo '<div class="m-0 p-0 mt-2 d-flex flex-row justify-content-center align-items-center">
                <div class="m-0 p-0 w-100" role="group">
                  ...
                  <div class="dropdown-menu dropdown-menu-right user-profile-dropdown-menu mt-1 p-0" aria-labelledby="user-profile-answer-request">
                    ...
                    <a class="dropdown-item last-item pt-2 pb-2 font-weight-bold" 
