...
<?
  ...
  {
?>
  <span class="m-0 mt-2 p-0 d-flex flex-row align-items-stretch">
    <p class="m-0 p-0">
    ...
    <p class="m-0 ml-1 p-0 fz-17 font-weight-bold"><?= (get_user_rating_among_all_users($current_user_uuid) != 0) ? get_user_rating_among_all_users($current_user_uuid) : '0 %'; ?></p>
  </span>
<?
  }
?>
  <span class="m-0 mt-2 p-0 font-weight-bold d-flex flex-row align-items-center">
    <p class="m-0 p-0">
    ...
    <p class="m-0 ml-1 p-0 fz-13 pointer" id="more-user-info">Подробнее</p>
  </span>
<?
