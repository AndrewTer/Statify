...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Списки друзей и подписчиков пользователя на сайте Statify">
    <meta name="Keywords" content="друзья, фотографии, сохранения, статистика, комментарии, сервис, оценка, оценивание, рейтинг">
  ...
  <body>
    ...
    <div class="container-fluid main-body p-0">
      <div class="row main-block m-0">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 main-content-friends">
          <div class="content container-fluid row m-0 p-0"><? include("includes/friends/friends-content.php"); ?></div>
        </div>
      </div>
    </div>
