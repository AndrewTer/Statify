										...
										<div class="w-100 m-0 mr-2 p-1 d-flex notifications-card-content">
											<div class="w-100 p-0">
												<div class="m-0 p-0 d-flex flex-row align-items-center">
													<p class="m-0 fz-12">'.corrected_date_with_text_month(date($comment_creation_date)).'</p>
													...
													<p class="m-0 ml-2 fz-13">'.$comment_count_of_replyig.'</p>
												</div>
									  					
												<hr class="hr-user-info m-0 mt-1 mb-1">

												<p class="w-100 m-0 p-0">Комментарий к <a href="comments?p='.preg_replace('[-]', '', $comment_picture_uuid).'"><em class="notifications-link">фотографии</em></a></p>
