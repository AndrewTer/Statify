...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Страница со списком сохранённых пользователем фотографий на сайте Statify">
    <meta name="Keywords" content="сервис, оценка, оценивание, фотографии, знакомства, просмотр статистики, достижения, внешность, оценка внешности">
  ...
  <body>
    ...
    <div class="container-fluid main-body p-0">
      <div class="row main-block m-0">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 main-content-saves">
          <div class="content container-fluid row m-0 p-0 block-saves"><? include("includes/saves/saves-content.php"); ?></div>
        </div>
      </div>
    </div>
