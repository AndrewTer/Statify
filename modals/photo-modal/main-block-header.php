...
<?
		...
		{
?>
			<p class="fz-16 m-0 w-100 text-left d-flex align-items-center"><?= get_user_fullname($user_uuid); ?>
...
<?
		...
		{
?>
    	<p class="fz-16 m-0 w-100 text-left"><?= get_user_fullname($user_uuid); ?></p>
<?
   	}
?>
