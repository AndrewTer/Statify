...
function corrected_date_with_text_month($date)
{
  ...
  switch ($date_month) {
    case '01': $date_month_text = "января";
      break;
    case '02': $date_month_text = "февраля";
      break;
    case '03': $date_month_text = "марта";
      break;
    case '04': $date_month_text = "апреля";
      break;
    case '05': $date_month_text = "мая";
      break;
    case '06': $date_month_text = "июня";
      break;
    case '07': $date_month_text = "июля";
      break;
    case '08': $date_month_text = "августа";
      break;
    case '09': $date_month_text = "сентября";
      break;
    case '10': $date_month_text = "октября";
      break;
    case '11': $date_month_text = "ноября";
      break;
    case '12': $date_month_text = "декабря";
      break;
    default: $date_month_text = "[месяца нет]";
      break;
  }
